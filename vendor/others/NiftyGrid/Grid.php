...
class Grid extends \Nette\Application\UI\Control
{
  ...
  /**
	 * @param array $new
	 */
	public function setNewLink($link, $text = "Pridanie nového prvku")
	{
		$this->new = array('link'=>$link, "text"=>$text);
//    dump($this->new);die();
	}
	...
	protected function createComponentGridForm()
	{
		...
		$form[$this->name]['perPage']->addSelect("perPage","Záznamou na stranu:", $this->perPageValues)
			->getControlPrototype()
